    ...
    <body class="antialiased bg-def" style="font-family: 'PT Sans', sans-serif;">
		...
		<nav class="bg-white shadow-lg">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					<li><a href="/" class="block text-sm px-2 py-4 text-white bg-pink-500 font-semibold">Home</a></li>
					<li class="active"><a href="/about" class="block text-sm px-2 py-4 hover:bg-pink-500 transition duration-300">About</a></li>
