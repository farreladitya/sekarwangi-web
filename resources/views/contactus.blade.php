        ...
        <section class="text-gray-700 body-font overflow-hidden bg-def">
            <div class="container px-5 py-16 mx-auto">
              <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded " src="{{ asset('img/logo.png') }}">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Sekarwangi Florist</h1>
                  <p class="leading-relaxed">Jl. Kayoon pasar bunga Stand 4C, Kaliasin, Genteng, Surabaya<br>
                  ...
                  <p class="leading-relaxed">Klik link berikut untuk mendapatkan informasi toko online kami

                   </p>
                 <a href="https://www.tokopedia.com/sekarwangifloris">Tokopedia</a> <br>
                 <a href="https://shopee.co.id/sekarwangiflorist">Shopee</a> <br>
                 <a href="https://www.instagram.com/sekarwangifloristsurabaya/">Instagram</a>
                </div>
              </div>
            </div>
        </section>
