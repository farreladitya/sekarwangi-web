                    ...
                    <div class="grid grid-cols-6 ">
                        ...
                        <div class="col-span-4 flex justify-center bg-center">
                            <div class="flex flex-col">
                                   ...
                                   <div class="py-1 text-4xl font-semibold">Category</div>
                                   <div class="py-3">
                                        <a href="/dashboard/category/tambah" class="text-black bg-def hover:bg-pink-300 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Add</a>
                                    </div>
                                        ...
                                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                    ...
                                                    <td class="py-4 px-6">
                                                        <a href="/dashboard/category/edit/{{ $c->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                                        <a href="/dashboard/category/hapus/{{ $c->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Hapus</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
