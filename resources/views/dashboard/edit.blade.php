                    ...
                    <div class="grid grid-cols-6 ">
                        ...
                        <div class="col-span-4 bg-center">
                            ...
                            <div class="flex flex-col">
                                   <div class="text-4xl py-1 mt-3 font-semibold">Product</div>
                                   <div class="py-3">
                                    ...
                                    <div class="px-3 py-3">
                                        ...
                                        <form action="/dashboard/update" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  type="text" placeholder="Name" name="name" value="{{ $p->name }}" required="required">
                                              </div>
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  type="text" placeholder="Price" name="price" value="{{ $p->price}}" required="required">
                                              </div>
                                            <div class="mb-4">
