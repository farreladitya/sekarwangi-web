...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-def" style="font-family: 'PT Sans', sans-serif;">
        ...
        <section class="text-gray-700 body-font overflow-hidden bg-def">
            <div class="container px-5 py-16 mx-auto">
              <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="{{ url('/product_image/'.$p->image) }}">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{$p->name}}</h1>
                  <p class="leading-relaxed">Anda dapat mempercayakan pemesanan bunga papan di kota surabaya di Sekarwangiflorist Surabaya <br>

                    Ingin menghubungi kami ? <br>

                    0821 3100 9336<br>
                    0822 32259990<br>

                    For info toko offline sekarwangiflorist.<br>

                    Jl. Kayoon pasar bunga Stand 4c Kaliasin Genteng Surabaya<br>

                    For Toko Online.<br>

                    Link Tokopedia Sekarwangiflorist
                    Link Instagram Sekarwangiflorist
                    Link Shoopee Sekarwangiflorist</p>
                  <div class="flex mt-2 items-center border-b-2 border-gray-200 mb-3">
                  </div>
                  <div class="flex">
                    <span class="title-font font-medium text-2xl text-gray-900">@php
                        echo "Rp. " . number_format($p->price,0,",",".",);
                        @endphp</span>
                    <a href="https://wa.me/6282232259990/" class="flex ml-auto text-white bg-green-700 border-0 py-2 px-6 focus:outline-none hover:bg-green-700 rounded">Order Now</a>
